...
import com.platform.common.core.aspect.LogAspect;
...
public class GlobalExceptionHandler  {
    ...
    public R<?> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        if (e.getCause() != null) {
            if (e.getCause() instanceof JsonParseException) {
                return R.fail(HttpEnum.BAD_REQUEST, "JSON格式错误");
            }
        }

        return R.fail(HttpEnum.INTERNAL);
    }
    ...
    public R<?> handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return R.fail(HttpEnum.BAD_REQUEST, violation.getMessage());
    }
    ...
    public R<?> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        if (fieldError != null) {
            return R.fail(HttpEnum.BAD_REQUEST, fieldError.getDefaultMessage());
        }
        return R.fail(HttpEnum.BAD_REQUEST);
    }
    ...
    @ResponseBody
    public R<?> handleUnknownException(Exception ex, HttpServletRequest request) {
        log.error("内部异常!", ex);
